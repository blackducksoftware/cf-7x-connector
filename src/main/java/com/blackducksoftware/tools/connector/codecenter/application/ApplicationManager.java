...
public class ApplicationManager implements IApplicationManager {
    ...
    private ApplicationUserPojo toAppUserPojo(ApplicationRoleAssignment roleAssignment)
            throws CommonFrameworkException {
        ApplicationUserPojo appPojo = new ApplicationUserPojo();

        appPojo.setApplicationName(roleAssignment.getApplicationNameVersionToken().getName());
        appPojo.setApplicationVersion(roleAssignment.getApplicationNameVersionToken().getVersion());
     ...
     */
    @Override
    public List<ApplicationUserPojo> getAllUsersAssignedToApplication(String appId)
            throws CommonFrameworkException {
        ...
        List<ApplicationUserPojo> appUsers = new ArrayList<>(roleAssignments.size());
