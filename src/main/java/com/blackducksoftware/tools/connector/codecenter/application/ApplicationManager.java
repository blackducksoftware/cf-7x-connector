...
public class ApplicationManager implements IApplicationManager {
    ...
    public ApplicationManager(CodeCenterAPIWrapper ccApiWrapper,
	    ...
	    ICodeCenterUserManager userMgr, ApplicationCache applicationCache) {
	...
	while (true) {
	    ...
	    log.debug("Fetching applications: index " + firstRowAsInt + "-"
		    + lastRowAsInt);
	    List<ApplicationPojo> partialAppList = getApplications(
     ...
     */
    @Override
    public void addUsersByIdToApplicationTeam(String appId,
	    Set<String> userIds, Set<String> roleNames, boolean circumventLock)
	    throws CommonFrameworkException {
     ...
     */
    @Override
    public void addUsersByNameToApplicationTeam(String appId,
	    Set<String> userNames, Set<String> roleNames, boolean circumventLock)
	    throws CommonFrameworkException {
    ...
    private void addUsersToApp(Application app,
	    List<UserNameOrIdToken> userIdTokens,
	    List<RoleNameOrIdToken> roleNameTokens)
	    throws CommonFrameworkException {
	...
	try {
	    ...
	    String msg = "Error adding users to application " + app.getName()
	...
	List<RoleNameOrIdToken> roleNameTokens = new ArrayList<>(
		roleNames.size());
    ...
    private void restoreLock(Application app, boolean origLockValue)
	    throws CommonFrameworkException {
	if (origLockValue) {
    ...
    private boolean ensureUnlocked(boolean circumventLock, Application app)
	    throws CommonFrameworkException {
     ...
     */
    @Override
    public void removeUserByIdFromApplicationTeam(String appId, String userId,
    ...
    public List<UserStatus> removeUsersByNameFromApplicationAllRoles(
	    String appId, Set<String> usernames, boolean circumventLock)
	    throws CommonFrameworkException {
	Application app = getSdkApplicationByIdCached(appId);
	...
	List<ApplicationUserPojo> originalTeam = getAllUsersAssignedToApplication(app
		.getId().getId());
	for (String username : usernames) {
		...
		boolean targetedUser = checkForTargetedUser(app, targetUserId,
    ...
    private boolean checkForTargetedUser(Application app, String targetUserId,
	    ApplicationUserPojo originalTeamMember) {
     ...
     */
    @Override
    public void updateAttributeValues(String appId,
    ...
    @Override
    public void removeApplicationFromCacheById(String appId)
	    throws CommonFrameworkException {
	applicationCache.remove(appId);
    }

    @Override
    public void removeApplicationFromCacheByNameVersion(String name,
	    String version) throws CommonFrameworkException {
